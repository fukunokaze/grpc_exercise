...
func (x *PrimeNumberDecomposeRequest) Reset() {
	*x = PrimeNumberDecomposeRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *PrimeNumberDecomposeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PrimeNumberDecomposeRequest) ProtoMessage() {}

func (x *PrimeNumberDecomposeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_calculator_calculatorpb_calculator_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PrimeNumberDecomposeRequest.ProtoReflect.Descriptor instead.
...
func (x *PrimeNumberDecomposeRequest) GetNumber() int32 {
	if x != nil {
		return x.Number
	}
	return 0
...
var file_calculator_calculatorpb_calculator_proto_rawDesc = []byte{
	...
	0x22, 0x35, 0x0a, 0x1b, 0x50, 0x72, 0x69, 0x6d, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x44,
	...
	0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x36, 0x0a, 0x1c, 0x50, 0x72, 0x69, 0x6d, 0x65,
	0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x44, 0x65, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x73, 0x65, 0x52,
	...
	0x75, 0x6c, 0x74, 0x32, 0x99, 0x02, 0x0a, 0x11, 0x43, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74,
	...
	0x65, 0x22, 0x00, 0x12, 0x6d, 0x0a, 0x14, 0x50, 0x72, 0x69, 0x6d, 0x65, 0x4e, 0x75, 0x6d, 0x62,
	0x65, 0x72, 0x44, 0x65, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x73, 0x65, 0x12, 0x27, 0x2e, 0x63, 0x61,
	0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x50, 0x72, 0x69, 0x6d, 0x65, 0x4e, 0x75,
	0x6d, 0x62, 0x65, 0x72, 0x44, 0x65, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x73, 0x65, 0x52, 0x65, 0x71,
...
var file_calculator_calculatorpb_calculator_proto_goTypes = []interface{}{
	...
	(*PrimeNumberDecomposeRequest)(nil),  // 1: calculator.PrimeNumberDecomposeRequest
	(*PrimeNumberDecomposeResponse)(nil), // 2: calculator.PrimeNumberDecomposeResponse
...
var file_calculator_calculatorpb_calculator_proto_depIdxs = []int32{
	...
	1, // 1: calculator.CalculatorService.PrimeNumberDecompose:input_type -> calculator.PrimeNumberDecomposeRequest
	...
	2, // 4: calculator.CalculatorService.PrimeNumberDecompose:output_type -> calculator.PrimeNumberDecomposeResponse
...
func file_calculator_calculatorpb_calculator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_calculator_calculatorpb_calculator_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PrimeNumberDecomposeRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type CalculatorServiceClient interface {
	...
	PrimeNumberDecompose(ctx context.Context, in *PrimeNumberDecomposeRequest, opts ...grpc.CallOption) (CalculatorService_PrimeNumberDecomposeClient, error)
...
func (c *calculatorServiceClient) PrimeNumberDecompose(ctx context.Context, in *PrimeNumberDecomposeRequest, opts ...grpc.CallOption) (CalculatorService_PrimeNumberDecomposeClient, error) {
...
func (x *calculatorServicePrimeNumberDecomposeClient) Recv() (*PrimeNumberDecomposeResponse, error) {
...
type CalculatorServiceServer interface {
	...
	PrimeNumberDecompose(*PrimeNumberDecomposeRequest, CalculatorService_PrimeNumberDecomposeServer) error
...
func (*UnimplementedCalculatorServiceServer) PrimeNumberDecompose(*PrimeNumberDecomposeRequest, CalculatorService_PrimeNumberDecomposeServer) error {
...
func (x *calculatorServicePrimeNumberDecomposeServer) Send(m *PrimeNumberDecomposeResponse) error {
